...
function scene:createScene( event )
	...
	local mapM = display.newImage("Level5M.png")
	mapM.x = 240
	mapM.y = 160
	mapM:scale(0.15,0.15)

	local mapB = display.newImage("Level5B.png")
	mapB.x = 60 
	mapB.y = 160
	mapB:scale(0.15,0.15)

	local mapD = display.newImage("Level5D.png")
	mapD.x = 420 
	mapD.y = 160
	mapD:scale(0.15,0.15)

	local mapA = display.newImage("Level5A.png")
	mapA.x = 240 
	mapA.y = 55
	mapA:scale(0.15,0.15)

	local mapC = display.newImage("Level5C.png")
	mapC.x = 240 
	mapC.y = 265
